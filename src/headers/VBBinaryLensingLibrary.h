...
namespace VBBinaryLensingLibrary {
...
#endif
	{
		...
		_curve *NewImages(VBBcomplex,VBBcomplex  *,_theta *);
		void OrderImages(_sols *,_curve *);
		void ComputeParallax(double,double,double *);
		void laguer(VBBcomplex *, int, VBBcomplex *, int*,double);
		void zroots(VBBcomplex *,int, VBBcomplex *, int,double);
