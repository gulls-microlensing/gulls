...
template<class T> const T sqr(const T a) //one multiply
{
  return a*a;
}

template<class T> const T cube(const T a) //two multiply
{
  return a*sqr(a);
}

template<class T> const T hCube(const T a) //two multiply
{
  return sqr(sqr(a));
}

template<class T> const T iPow(const T a, const int beta)
{
  T b;
...
double qAdd(const double a, const double b)
{
  return ((abs(a)>=abs(b)) ? abs(a)*sqrt(1.0+sqr(b/a)):abs(b)*sqrt(1.0+sqr(a/b)) );
}

double qAdd(const double a, const double b, const double c)
{
  double aa=abs(a);
  double ab=abs(b);
  double ac=abs(c);
...
void qroot(const double a, const double b, const double c, complex<double>& r1, complex<double>& r2)
{
  double q;
  double disc;
  complex<double> cq;
...
void qroot(const complex<double> a, const complex<double> b, const complex<double> c, complex<double>& r1, complex<double>& r2)
{
  complex<double> disc;
  complex<double> cq;
  double sign=1.0;
...
/*template<class T> const T max(const T a_,const T b_)
{
  return (a_>=b_?a_:b_);
}

template<class T> const T min(const T a_,const T b_)
{
  return (a_<=b_?a_:b_);
  }*/
