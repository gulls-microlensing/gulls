...
CPPFLAGS = $(WFLAGS) $(OPT) -I/home/penny/apps/cfitsio-4.3.0/ -I/home/penny/include/ -I$(BASEDIR)/headers/ -lm -lstdc++ -ansi -fPIC  -Wextra -DNDEBUG -std=c++11 -fsanitize=address
